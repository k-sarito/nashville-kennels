...
export const getAllAnimals = () => {
  return fetch(`${remoteURL}/animals?isDischarged=false`)
  .then(res => res.json())
}
export const getDischargedAnimals = () => {
  return fetch(`${remoteURL}/animals?_isDischarged=true`)
  .then(res => res.json())
...
export const getAnimalByLocation = id => {
  return fetch(`${remoteURL}/animals?locationId=${id}`)
  .then(res => res.json())
}
