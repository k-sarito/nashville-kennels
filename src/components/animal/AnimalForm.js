...
export const AnimalForm = () => {
	...
	const formatDate =(date) => {
		...
		// console.log(isoDate)
		// const splitDate = isoDate.split("T")[0]
	...
	return (
		<form className="animalForm">
			...
			<fieldset>
				<div className='form-group'>
					<label htmlFor='date'>Admitted Date:</label>
					<input type="date" id='date' className='form-control' onChange={handleControlledInputChange} value={animal.date}/>
				</div>
			</fieldset>
			<fieldset>
				<div className="form-group">
